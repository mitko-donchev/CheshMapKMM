...
import com.epicmillennium.cheshmap._androidIntentFlow
import com.epicmillennium.cheshmap.appContext
...
actual class GPSService {
    ...
    private fun startGPSLocationUpdates(
        ...
        if (locationCallback == this@GPSService.locationUpdateCallback) return // already using same callback
        this@GPSService.locationUpdateCallback = locationCallback
        this@GPSService.errorCallback = errorCallback
